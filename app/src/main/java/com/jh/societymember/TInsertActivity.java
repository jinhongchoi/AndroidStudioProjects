    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mFirebaseAuth.signInWithEmailAndPassword(strEmail, strPwd).addOnCompleteListener(TInsertActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(TInsertActivity.this, "로그인 실패!",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TInsertActivity.this, RegisterActivity.class);
