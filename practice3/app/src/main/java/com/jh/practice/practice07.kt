...
class androidpractice07 : AppCompatActivity() {
    ...
    var k=1
    val pointlist = mutableListOf<Float>() //()안에 아무것도 안넣어 주는게 비워준 상태!
    ...
    fun end(){
        ...
        k=pointlist.indexOf(pointlist.maxOrNull()) //indexOf-> 배열에서 원하는 인덱스값 나오게!
        text_people.text = "참가자 "+(k+1)
