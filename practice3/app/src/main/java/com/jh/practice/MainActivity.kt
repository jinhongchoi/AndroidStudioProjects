...
//        val colorlist = mutableListOf<String>("FFF3A001","FFF3A004","FFF3A007","FFF3AF2E","FFF3AE5E","FFF3AE8E","FFF3AEB0")
//        var color_index= k%7-1
//        if(color_index==-1){
//            color_index=6
//        }
//
//        val color_sel=colorlist.get(color_index)//get 안에는 index밖에 들어가지 String type을 그냥 넣는게 아니라 index만 가져오게 한다!
//
//        bg_main.setBackgroundColor(Color.parseColor(color_sel)) //배경화면에 색을 넣는 코드!
//
//        //이거 색 변하는거 왜 안되는지 해결할 것!
